...
1. **What tools did you use?** (e.g., ChatGPT, Claude, GitHub Copilot)
   ...
   ____________________________Claude_____________________________________

2. **What specific things did you ask them to do?** (Be specific)
   
   ________define encoder, standarization_________________________________________________________
...
3. **How much of your final code came from AI vs. your own work?** (e.g., "AI gave me the formula, I wrote the loop" or "AI helped me debug an error")
   ...
   _______________________First I coded yself and AI helped me to debugg my error__________________________________________
